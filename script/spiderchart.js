    ...
    function drawRadarCharts(json) {
      drawRadarChart('#diagram_1', wMaior, wMaior, json,legendOptions);
    };

    function drawRadarChart(divId, w, h, data, legendOptions) {
      var textSizeLevels = "8px !important";
      var textSizeTooltip = "8px !important";
      var textSizeLegend = "8px !important";
      var circleSize = 5;
        ...
        draw: function(id, data, options) {
          ...
          for (var j = 0; j < cfg.levels; j++) {
            ...
            g.selectAll(".levels")
              ...
              .attr("fill", "#737373")
              .text(Math.floor((j + 1) * cfg.maxValue / cfg.levels));
          }
    ...
    function update(json, legendOptions) {
      drawRadarChart('#diagram_1', wMaior, wMaior,json, legendOptions);
    };
